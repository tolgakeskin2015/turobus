  ...
  async function removeSelectedGuest() {
    ...
    try {
      const deletionReason =
        window.prompt(
          "Misafir profilini neden siliyorsunuz? Bu bilgi işlem geçmişinde saklanacaktır.",
          "Yanlış veya mükerrer kayıt"
        );
      ...
      <div className="mx-auto max-w-[1900px]">
        <header className="flex flex-col justify-between gap-6 xl:flex-row xl:items-end">
          ...
          <div className="flex flex-wrap gap-3">
            <Link
              href="/dashboard/hotel/misafirler/cop-kutusu"
              className="flex min-h-14 items-center justify-center gap-3 rounded-2xl border border-white/10 px-6 font-black text-slate-300 transition hover:border-orange-400/40 hover:text-orange-400"
            >
              <FaTrash />

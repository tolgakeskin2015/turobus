          ...
          <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Operasyon, housekeeping, finans ve özel istek notlarını yönetin.
              </p>
            </div>
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  ...
                  <button
                    ...
                    className="flex min-h-10 items-center justify-center gap-2 rounded-xl border border-red-500/20 bg-red-500/15 px-3 text-xs font-black text-red-400 transition hover:bg-red-500/25 disabled:cursor-not-allowed disabled:opacity-40"
                  >
                    <FaTrash />
                    Sil
                  </button>
        ...
        <div className="mt-6">
          <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Kimlik, pasaport, KVKK ve konaklama belgelerini yönetin.
              </p>
            </div>

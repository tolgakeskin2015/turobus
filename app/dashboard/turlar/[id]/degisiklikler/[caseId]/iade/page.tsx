...
export default function TourRefundFinancePage() {
  ...
  const load =
    useCallback(
      async (
        ...
        setApprovedAmount(
          String(
            loadedCase.approved_refund_amount ??
            0
          )
        );
  ...
  async function approveRefundLimit() {
    ...
    await rpc(
      "approve_tour_change_case_refund",
      {
        ...
        p_note:
          "Finans onay tutarı güncellendi.",
      },
  ...
  async function completeManual(
    ...
    if (
      !window.confirm(
        "Manuel iadenin müşteriye gerçekten ödendiğini onaylıyor musunuz?"
      )
    ) {
      return;
    }
    ...
    await rpc(
      "complete_manual_tour_change_refund",
      {
        ...
        p_note:
          "Manuel ödeme finans tarafından tamamlandı.",
      },
  ...
  async function prepareProvider(
    ...
    await rpc(
      "start_provider_tour_change_refund",
      {
        p_refund_id:
          refundId,
      },
      "Provider iadesi işleme alındı. Gerçek provider çağrısı henüz yapılmadı."
    );
  }
          ...
          <div className="flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
            ...
            <div>
              ...
              <p className="mt-2 text-[9px] text-slate-400">
                Onaylı iade limiti, kısmi/tam iade defteri ve finans hareketleri.
              </p>
              ...
              <tbody>
                ...
                {refunds.map(
                  refund => (
                    ...
                    <tr
                      ...
                      className="border-t border-white/[.055] text-[8px] font-bold"
                    >
                      ...
                      <td className="px-4 py-4 text-right">
                        ...
                        {refund.method ===
                          ...
                          <button
                            ...
                            className="inline-flex items-center gap-2 rounded-lg bg-emerald-500 px-3 py-2 text-[7px] font-black text-white"
                          >
                            <FaCheckCircle />
                            Ödendi
                          </button>
                        ...
                        {refund.method ===
                          ...
                          <button
                            ...
                            className="inline-flex items-center gap-2 rounded-lg bg-blue-500 px-3 py-2 text-[7px] font-black text-white"
                          >
                            <FaPlay />
                            Provider Hazırla
                          </button>
                ...
                {refunds.length ===
                  ...
                  <tr>
                    <td
                      colSpan={8}
                      className="px-6 py-12 text-center text-[8px] text-slate-600"
                    >
        ...
        <section className="mt-5 rounded-[20px] border border-amber-500/15 bg-amber-500/[.035] p-4">
          ...
          <div className="flex gap-3">
            ...
            <div className="text-[8px] font-bold leading-5 text-amber-100/75">
              “Provider Hazırla” gerçek banka/kart iadesi yapmaz. Bu aşama yalnız finans defterini processing durumuna alır. Genel ödeme modülünde provider refund endpoint doğrulanmadan gerçek iyzico çağrısı yapılmayacaktır.
            </div>

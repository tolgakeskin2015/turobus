...
export default function TourBusOperationsPage() {
  ...
  const operationStops =
    useMemo(
      () =>
        stops
          .filter(
            item =>
              item.bus_operation_id ===
              selectedOperationId
          )
          .sort(
            (a, b) =>
  ...
  useEffect(() => {
    ...
    setBusForm({
      vehicleId:
        selectedOperation.vehicle_id ??
        "",
      busNo:
        String(
          selectedOperation.bus_no
        ),
      driver1Name:
        selectedOperation.driver_1_name ??
        "",
      driver1Phone:
        selectedOperation.driver_1_phone ??
        "",
      driver2Name:
        selectedOperation.driver_2_name ??
        "",
      driver2Phone:
        selectedOperation.driver_2_phone ??
        "",
      guideName:
        selectedOperation.guide_name ??
        "",
      guidePhone:
        selectedOperation.guide_phone ??
        "",
      operationsPhone:
        selectedOperation.operations_phone ??
        "",
      seatCapacity:
        selectedOperation.seat_capacity ===
        null
          ? ""
          : String(
              selectedOperation.seat_capacity
      ...
      departureAt:
        localDateTime(
          selectedOperation.departure_at
        ),
      returnAt:
        localDateTime(
          selectedOperation.return_at
        ),
      status:
  ...
  async function createBus() {
    ...
    try {
      ...
      setNotice(
        `Otobüs ${nextBusNo} operasyonu oluşturuldu.`
      );
  ...
  async function generateSeats() {
    ...
    if (
      ...
      setError(
        "Koltuk kapasitesi 1 ile 100 arasında olmalı."
      );
      return;
    }
    ...
    if (
      ...
      setNotice(
        "Koltuk planı zaten oluşturulmuş."
      );
      return;
    }
    ...
    try {
      ...
      setNotice(
        `${rows.length} koltuk oluşturuldu.`
      );
  ...
  async function removeStop(
    ...
    if (
      !window.confirm(
        "Bu biniş noktasını silmek istiyor musunuz?"
      )
    ) {
      return;
    }
      ...
      const {
        ...
        await supabase
          ...
          .update({
            passenger_name:
              nullText(
                seatForm.passengerName
              ),
            passenger_phone:
              nullText(
                seatForm.passengerPhone
              ),
            boarding_stop_id:
              seatForm.boardingStopId ||
              null,
            notes:
              nullText(
                seatForm.notes
              ...
              <section className="space-y-5">
                ...
                <div className="rounded-[26px] border border-white/[.08] bg-[linear-gradient(145deg,#081520,#050c13)] shadow-[0_14px_40px_rgba(0,0,0,.12)] p-5">
                  ...
                  <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <button
                      ...
                      className="inline-flex min-h-10 items-center justify-center gap-2 rounded-xl border border-orange-500/20 bg-orange-500/[.06] px-4 text-[8px] font-black text-orange-300"
                    >
                      <FaPlus />
                  ...
                  0 ? (
                    ...
                    <div className="mt-6 mx-auto max-w-[560px] rounded-[28px] border border-white/[.08] bg-[#03080e] p-5">
                      ...
                      <div className="mb-6 flex items-center justify-between border-b border-white/[.06] pb-4">
                        ...
                        <div className="rounded-xl border border-white/10 bg-white/[.03] px-4 py-2 text-[7px] font-black text-slate-500">
                          ÖN
                        </div>
                ...
                <div className="rounded-[26px] border border-white/[.08] bg-[linear-gradient(145deg,#081520,#050c13)] shadow-[0_14px_40px_rgba(0,0,0,.12)]">
                  ...
                  <div className="border-b border-white/[.06] p-5">
                    ...
                    <div className="mt-1 text-[7px] text-slate-600">
                      Hangi yolcu hangi koltukta, nereden binecek ve araca bindi mi?
                    </div>
                                  ...
                                  <td className="px-4 py-3">
                                    ...
                                    <div className="flex justify-end gap-2">
                                      ...
                                      <button
                                        ...
                                        className="rounded-lg border border-white/10 px-3 py-2 text-[7px] font-black"
                                      >
                                        Aç
                                      </button>
                                      ...
                                      <button
                                        ...
                                        className="rounded-lg border border-emerald-500/20 bg-emerald-500/[.06] px-3 py-2 text-[7px] font-black text-emerald-300 disabled:opacity-40"
                                      >
                                        Bindi ✓
                                      </button>
                                      ...
                                      <button
                                        ...
                                        className="rounded-lg border border-red-500/20 bg-red-500/[.05] px-3 py-2 text-[7px] font-black text-red-300"
                                      >
                                        Gelmedi
                                      </button>
            ...
            <div className="w-full max-w-md rounded-[26px] border border-white/[.08] bg-[linear-gradient(145deg,#081520,#050c13)] shadow-[0_14px_40px_rgba(0,0,0,.12)] p-5 shadow-2xl">
              ...
              <div className="mt-5 grid gap-3">
                ...
                <button
                  ...
                  disabled={busy}
                  onClick={() =>
                    void saveSeatPassenger()
                  }
                  className="inline-flex h-11 items-center justify-center gap-2 rounded-xl bg-orange-500 text-[8px] font-black"
                >
                  <FaUserCheck />
                  Yolcu / Koltuk Kaydet
                </button>

...
type Item = {
  ...
  supplier_room_confirmation: RoomConfirmation[];
};
...
export default function SupplierRoomConfirmationPanel({
  roomPlan,
  items,
}: {
  roomPlan: RoomPlan[];
      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <div>
          ...
          <p className="mt-2 text-sm text-slate-400">
            Satılan oda planı ile tedarikçinin verdiği teyidi karşılaştırır.
          </p>
        </div>
